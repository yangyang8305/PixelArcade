...
const TRANSLATIONS = {
  en: {
    ...
    'section.recent':'🕒 Recently Played','section.more':'🎮 More Games',
  ...
  zh: {
    ...
    'btn.loadmore':'加载更多',
    'section.recent':'🕒 最近玩过','section.more':'🎮 更多游戏',
  ...
  ja: {
    ...
    'btn.loadmore':'もっと見る',
    'section.recent':'🕒 最近プレイした','section.more':'🎮 その他のゲーム',
  ...
  ar: {
    ...
    'section.recent':'🕒 لُعبت مؤخراً','section.more':'🎮 المزيد من الألعاب',
  ...
  es: {
    ...
    'section.recent':'🕒 Jugados recientemente','section.more':'🎮 Más juegos',
  ...
  fr: {
    ...
    'section.recent':'🕒 Joués récemment','section.more':'🎮 Plus de jeux',
  ...
  de: {
    ...
    'section.recent':'🕒 Zuletzt gespielt','section.more':'🎮 Mehr Spiele',
  ...
  ko: {
    ...
    'btn.loadmore':'더 보기',
    'section.recent':'🕒 최근 플레이','section.more':'🎮 더 많은 게임',
  ...
  ru: {
    ...
    'section.recent':'🕒 Недавние игры','section.more':'🎮 Больше игр',
  ...
  pt: {
    ...
    'section.recent':'🕒 Jogados recentemente','section.more':'🎮 Mais jogos',
  ...
  hi: {
    ...
    'section.recent':'🕒 हाल में खेले गए','section.more':'🎮 और गेम्स',
    'search.placeholder':'गेम खोजें...',
  ...
  tr: {
    ...
    'section.recent':'🕒 Son Oynananlar','section.more':'🎮 Daha Fazla Oyun',
